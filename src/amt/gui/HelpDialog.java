...
public class HelpDialog extends javax.swing.JDialog {
  ...
  private void initComponents() {
    ...
    titleLabel.setFont(new java.awt.Font("Lucida Grande", 1, 13));
    titleLabel.setText("Help Content");

    lineOneLabel.setFont(new java.awt.Font("Lucida Grande", 0, 11));
    lineOneLabel.setText("Constants. Out: Auxiliaries. In: Nothing.      ");

    lineTwoLabel.setFont(new java.awt.Font("Lucida Grande", 0, 11));
    lineTwoLabel.setText("Auxiliaries. Out: Flow or Auxiliaries. In: Constsants, Auxiliaies, Stock or Flow.     ");

    lineThreeLabel.setFont(new java.awt.Font("Lucida Grande", 0, 11));
    lineThreeLabel.setText("Stocks. Out: Flow or Auxiliar. In: Stock or Flow.     ");

    lineFourLabel.setFont(new java.awt.Font("Lucida Grande", 0, 11));
