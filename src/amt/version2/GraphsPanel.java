...
//    allGraphsPanel.setLayout(gl);
//    //Only display the correct graph once the user has assigned the correct name and description to the node
//    if (node.nodeName.equals(node.label)) {
//      allGraphsPanel.add(correctGraphLabel);
//      correctGraphLabel.setAlignmentX(JLabel.CENTER);
//      allGraphsPanel.add(correctAnswerPanel);
//    }
//    allGraphsPanel.add(userGraphLabel);
//    userGraphLabel.setAlignmentX(JLabel.CENTER);
//    allGraphsPanel.add(graphPanel);
    allGraphsPanel.removeAll();
