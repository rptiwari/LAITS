...
class PopupEdgeMenu extends PopupMenu implements ActionListener {
   ...
   */
  public PopupEdgeMenu(Selectable selectable, GraphCanvas gc, JFrame jf, Graph g, JMenuItem run, JMenuItem takeQuiz) {
    super();
  ...
  /**
    ...
    public void actionPerformed(ActionEvent e)
    {
        ...
        {
            Edge edge = (Edge) selectable;
            logs.concatOut(Logger.ACTIVITY, "PopupEdgeMenu.actionPerformed.1", edge.edgetype + "-" + edge.start.label + "-" + edge.end.label);
