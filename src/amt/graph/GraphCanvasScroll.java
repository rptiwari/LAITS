...
public class GraphCanvasScroll extends JPanel implements MouseListener, KeyListener {
  ...
  /**
    ...
    /*
    public GraphCanvasScroll(JFrame jf, Graph g, JMenuItem run, JMenuItem takeQuiz, LinkedList<int[]> problemList, /*Server server,* ProblemView problemView,ProblemView instructionView,JTabbedPane tabPane) {
      super(new BorderLayout());
      area = new Dimension(0, 0);
      this.jf = jf;
        this.graph = g;
        graphCanvas = new GraphCanvas(jf, graph, run, takeQuiz, problemList, /*server,* problemView, instructionView,tabPane);
        graphCanvas.setBackground(Color.white);
        graphCanvas.addMouseListener(this);
        graphCanvas.setFocusable(true);
        graphCanvas.addKeyListener((KeyListener) this);
    ...
    */
     ...
     * @param l
     */
    public void setButtonLabel(JLabel l){
        this.graphCanvas.setButtomLabel(l);
    }
    ...
    /*REVIEW WITH JAVIER IF WE ARE USING THESE TWO FOLLOWING METHODS */
    @Override
