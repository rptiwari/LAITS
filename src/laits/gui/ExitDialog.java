  ...
  @SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        PanelLayout.setHorizontalGroup(
            ...
            .addComponent(titleLabel, javax.swing.GroupLayout.DEFAULT_SIZE, 278, Short.MAX_VALUE)
   ...
   private void yesButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_yesButtonActionPerformed
     ...
     if (Main.professorVersion != Main.DEMO && Main.professorVersion != Main.DEMO_VERSION2) {
      ...
      BlockSocket.getBlockSocket().blockQuery(this,"ENDING SESSION");
      try {
        Thread.sleep(1000);
      } catch (InterruptedException ex) {
        java.util.logging.Logger.getLogger(Main.class.getName()).log(Level.SEVERE, null, ex);
      }
      ActSocketServer.getActSocketServer().close();
      BlockSocket.getBlockSocket().close();
