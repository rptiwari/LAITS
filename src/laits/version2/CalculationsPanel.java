...
//    int size = currentVertex.equation.codeList.size();
//    for(int i=0;i<size;i++){
//        parent.savedCodeList.add(currentVertex.equation.codeList.get(i));
//    }
//    size = currentVertex.equation.tokenList.size();
//    for(int i=0;i<size;i++){
//        parent.savedTokenList.add(currentVertex.equation.tokenList.get(i));
//    }
//    size = currentVertex.equation.value.size();
//    for(int i=0;i<size;i++){
//        parent.savedValue.add(currentVertex.equation.value.get(i));
//    }
//    parent.savedStockEqation=currentVertex.stockEquation;
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addContainerGap(949, javax.swing.GroupLayout.PREFERRED_SIZE))
        );
