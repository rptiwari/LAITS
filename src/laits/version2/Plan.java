...
public class Plan extends javax.swing.JPanel {
    ...
    public Plan(TabbedGUI parent, Vertex v, Graph g, GraphCanvas gc) {
        this.parent = parent;
        this.g = g;
        this.gc = gc;
        ...
        pt = PlanTree.getPlanTree(currentVertex.nodeName);
    ...
    public void initializePlan() {
        ...
        String title = "Is \"" + currentVertex.nodeName + "\" a : ";
    ...
    private void prevButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_prevButtonActionPerformed
        ...
        if (traversedList.isEmpty()) {
            ...
            String t = "Is \"" + currentVertex.nodeName + "\" a : ";
